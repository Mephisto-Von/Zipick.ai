        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2">
              <img src="/zipick-logo.png" alt="Zipick.ai" className="h-6 w-auto" />
            </Link>
            <p className="mt-4 text-sm text-gray-500 max-w-xs">
              The smartest way to shop online. Find the perfect product in seconds using the power of Artificial Intelligence.
            </p>
          </div>
          ...
          <div>
            <h4 className="text-sm font-semibold text-gray-900">For Business</h4>
            <ul className="mt-4 space-y-2">
              <li><a href="/procurement" className="text-sm text-gray-500 hover:text-gray-900">Zipick for Business</a></li>
              <li><a href="#" className="text-sm text-gray-500 hover:text-gray-900">Partner with Us</a></li>
              <li><a href="#" className="text-sm text-gray-500 hover:text-gray-900">API Access</a></li>
            </ul>
          </div>
        </div>

        <div className="mt-8 border-t border-gray-200 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
